 ...
 */
public class PredictionsListAdapter extends ArrayAdapter<String> {
    private String[] date;
    ...
    public PredictionsListAdapter(Activity context, String[] date, String homeTeamName[], String awayTeamName[], String score[], String imgId[]) {
